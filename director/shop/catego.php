            ...
            <div class="col-md-12 my-4">
              <div class="row align-items-center my-3">
                <div class="col">
                  ...
                  <p class="mb-3">Explore our wide range of product categories, each offering a unique selection of items to meet your needs. Whether you're looking for books, school uniforms, stationery, sports equipment, or school bags, we have you covered. Browse through our categories and find the perfect products for your requirements.</p>
                </div>
                <div class="col-auto">
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0 text-muted">
                                <strong class="mb-0 text-muted designation-name" data-designation-id="<?= $designation['category_id'] ?>">
                                  <?= $designation['category_name'] ?>
                                </strong>
                                <input type="hidden" class="designation-id" value="<?= $designation['category_name'] ?>">
                              </p>
                            </td>
                            ...
                            <td>
                              <p class="mb-0 text-muted">
                                <strong class="mb-0 text-muted department-name">
                                  <?= $designation['category_description'] ?>
                                </strong>
                              </p>
                            </td>
                            <td>
