      ...
      <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item active">
            <a class="nav-link text-primary" href="process.php">
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">Process Applications</h2>

              </div>
              <div class="col-auto">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eventModal"><span class="fe fe-filter fe-12 mr-2"></span>Filter</button>
              </div>
              <div class="modal fade" id="eventModal" tabindex="-1" role="dialog" aria-labelledby="eventModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="varyModalLabel">Filter Applications</h5>
                      ...
                      <form>
                        ...
                        <div class="form-row">
                          <div class="form-group col-12">
                            <label for="eventType">Session</label>
                            <select id="eventType" class="form-control select2">
                              <option value="work">select</option>
                              <option value="home">2023/2024</option>
                            </select>
                          </div>
                        </div>
                        <div class="form-row">
                          <div class="form-group col-12">
                            <label for="eventType">Term</label>
                            <select id="eventType" class="form-control select2">
                              <option value="work">select</option>
                              <option value="home">First Term</option>
                              <option value="home">Second Term</option>
                              <option value="home">Third Term</option>
                            </select>
                          </div>
                        </div>
                      </form>
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                      ...
                      <button type="button" class="btn mb-2 btn-primary">Filter</button>
                    </div>
                  </div>
                </div>
              </div> <!-- new event modal -->
