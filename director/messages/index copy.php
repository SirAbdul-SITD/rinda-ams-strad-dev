                ...
                <div class="card shadow bg-primary text-center mb-4">
                  <div class="card-body p-5">
                    ...
                    <p class="text-white mb-4">Send custom notifications to parents, non-academic staffs, teachers and
                      students</p>
                    <a href="#" class="btn btn-lg bg-primary-light text-white">New Notification<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                  </div> <!-- .card-body -->
                </div> <!-- .card -->
              </div> <!-- .col-md-->
              <div class="col-md-6">
                <div class="card shadow bg-success text-center mb-4">
                  <div class="card-body p-5">
                    ...
                    <p class="text-white mb-4">Start a live chat with parents, non-academic staffs, teachers and
                      students</p>
                    <a href="#" class="btn btn-lg bg-success-light text-white">New Chat<i class="fe fe-arrow-right fe-16 ml-2"></i></a>
                  </div> <!-- .card-body -->
                </div> <!-- .card -->
              </div> <!-- .col-md-->
            </div> <!-- .row -->
