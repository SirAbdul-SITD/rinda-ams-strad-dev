      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            ...
            <form id="send-message" method="POST" action="send-message-parent.php">
              <div class="row my-4">
                <div class="col-md-9">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header justify-content-center">
          <h5 class="modal-title text-center" id="successModalTitle">Message Sent</h5>
        </div>
        <form id="proceed-new" action="application.php">
          <div class="modal-body">
            <p class="text-center">Your message has been sent to selected receipiants successfully.</p>
          </div>
          <div class="modal-footer">
            <button type="submit" class="btn mb-2 btn-primary w-100">Done!</button>
          </div>
        </form>
      </div>
    </div>
