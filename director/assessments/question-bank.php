...
<head>
  ...
  <title>Question Bank - Assessment | Rinda AMS</title>
  <!-- Simple bar CSS -->
      ...
      <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          <li class="nav-item active">
            <a class="nav-link text-primary" href="question-bank.php">
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <h2 class="h4 mb-1">Question Bank</h2>
                <p class="mb-3">Welcome to our Question Bank – a hub of knowledge and exploration. Dive in and discover
                  a world of learning across various subjects. Let your curiosity guide you through our rich collection
                  of past questions, each a gateway to new insights and understanding.</p>
                      ...
                      <tbody>
                        ...
                        if ($stmt->rowCount() > 0) {
                          while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<td><button class='btn btn-sm copy-icon' data-question='{$row['question']}' title='Copy Question'><i class='fe fe-copy fe-24'></i></button></td>";
                            echo "</tr>";
                          }
                        } else {
                          echo "<tr class='text-center'><td colspan='7'>No data available</td></tr>";
                        }
                        ?>
  ...
  <script>
    ...
    document.querySelectorAll('.copy-icon').forEach(function(button) {
      button.addEventListener('click', function() {
        ...
        var question = row.querySelector('td:nth-child(3)').textContent;
        navigator.clipboard.writeText(question)
          .then(function() {
            displayPopup("Copied! Question: " + question, true);
          })
