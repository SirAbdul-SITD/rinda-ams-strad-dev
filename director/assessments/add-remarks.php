...
<head>
  ...
  <title>Remarks - Assessments | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">Result Remarks</h2>
                <p class="mb-3">The following students are from classes assigned to you, Please select a student to add or update their result remarks</p>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        ...
                        try {
                          ...
                          $sql = "SELECT s.admission_no, s.id, CONCAT(s.firstName, ' ', s.lastName) AS full_name, CONCAT(u.first_name, ' ', u.last_name) AS teacher_name, c.class, a.teacher_id, a.class_id
            FROM students s
            ...
            WHERE s.status = 1";
                        ...
                        foreach ($students as $index => $student) : ?>
                          <tr>
                            ...
                            <td>
                              <form action="student-remark.php" method="POST">
                                <input type="hidden" name="student" value="<?= $student['id']; ?>">
                                <button type="submit" class="btn  w-100 btn-primary"><i class="fe fe-edit-3 fe-16"></i>
                                  Add Remarks</button>
                              </form>
