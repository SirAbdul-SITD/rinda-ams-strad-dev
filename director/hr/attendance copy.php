          ...
          <div class="col-12">
            <div class="row align-items-center my-3">
              ...
              <div class="col-auto">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eventModal"><span class="fe fe-filter fe-16 mr-3"></span>Filter</button>
              </div>
            </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="varyModalLabel">Filter Attendance</h5>
                    ...
                    <form>
                      ...
                      <div class="form-group col-12">
                        ...
                        <select id="eventType" class="form-control select2">
                          <option value="work"> Select session</option>
                        </select>
                      </div>

                      <div class="form-row">
                        <div class="form-group col-6">
                          <label for="eventType">From</label>
                          <select id="eventType" class="form-control select2">
                            <option value="work"> Select week</option>
                          </select>
                        </div>

                        <div class="form-group col-6">
                          <label for="eventType">To</label>
                          <select id="eventType" class="form-control select2">
                            <option value="work"> Select week</option>
                          </select>
                        </div>
                  ...
                  <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="btn mb-2 btn-primary">Search</button>
                  </div>
                </div>
              </div>
            </div> <!-- new event modal -->
