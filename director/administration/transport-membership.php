...
<head>
  ...
  <title>Membership - Transportation | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h3 class="page-title">Transport Membership</h3>
              </div>
              <div class="col-auto">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eventModal"><span class="fe fe-plus fe-16 mr-3"></span>Add Member</button>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>(478) 446-9234</td>
                          <td>300</td>
                          <td>9022 Suspendisse Rd. Dawaki, Abuja</td>
                        ...
                        <tr>
                          ...
                          <td>(234) 567-8901</td>
                          <td>400</td>
                          <td>123 Main Street, Utako, Abuja</td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>(345) 678-9012</td>
                          <td>500</td>
                          <td>456 Elm Street, Wuse, Abuja</td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
                            </button>
                        ...
                        <tr>
                          ...
                          <td>4</td>
                          <td>Nurudeen Yusuf</td>
                          <td>Grade 3</td>
                          <td>(456) 789-0123</td>
                          <td>350</td>
                          <td>789 Oak Avenue, Maitama, Abuja</td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
                            </button>
                        ...
                        <tr>
                          ...
                          <td>(567) 890-1234</td>
                          <td>450</td>
                          <td>321 Pine Street, Gwarimpa, Abuja</td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
                            </button>
