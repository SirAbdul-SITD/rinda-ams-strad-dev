...
<head>
  ...
  <title>Routes - Transportation | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item">
            <a class="nav-link" href="students.php">
              ...
              <span class="ml-3 item-text">Fees Type</span>
              </i>
            </a>
          </li>
            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  ...
                  <div class="col-auto">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eventModal"><span class="fe fe-plus fe-16 mr-3"></span>Add New Route</button>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-borderless table-hover">
                      ...
                      <tbody>
                        ...
                        if (count($routes) > 0) {
                          // Loop through each route and display it in the table
                          foreach ($routes as $index => $route) {
                            echo "<tr>";
                            echo "<td>" . ($index + 1) . "</td>";
                            echo "<td>" . $route['route'] . "</td>";
                            echo "<td>" . $route['Type'] . "</td>";
                            echo "<td>" . $route['Category'] . "</td>";
