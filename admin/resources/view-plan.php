...
if (isset($_GET['subtopic'])) {
  ...
  if ($planRow) {
    ...
    if (curl_errno($curl)) {
      ...
      $plan = $responseData['result']['response'];

      $stmt = $pdo->prepare("INSERT INTO curriculum_plans (class, subject, topic, subtopic, plan) VALUES (:class, :subject, :topic, :subtopic, :plan)");
      $stmt->bindParam(':class', $class, PDO::PARAM_STR);
      $stmt->bindParam(':subject', $subject, PDO::PARAM_STR);
      $stmt->bindParam(':topic', $topic, PDO::PARAM_STR);
      $stmt->bindParam(':subtopic', $subtopic, PDO::PARAM_STR);
...
<head>
  ...
  <title>Lesson Plan - Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              ...
              <p>This page includes a range of contrasting styles that support the needs of your plans modifications.</p>
