...
<head>
  ...
  <title>Modify Past Assessments - Assessments | Rinda AMS</title>
  <!-- Simple bar CSS -->
      ...
      <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item active">
            <a class="nav-link text-primary" href="past-results.php">
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">Assigned Students</h2>
                <p class="mb-3">Please select a students to update assessment marks for for <?= $term_name ?> - <?= $session ?> Session</p>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        ...
                        try {
                          ...
                          $sql = "SELECT s.admission_no, s.id, CONCAT(s.firstName, ' ', s.lastName) AS full_name, c.class, a.teacher_id, CONCAT(u.first_name, ' ', u.last_name) AS teacher_name, a.class_id
            FROM students s INNER JOIN classes c ON s.class_id = c.id OR s.2ndClass_id = c.id
            ...
            WHERE s.status = 1";
                        ...
                        foreach ($students as $index => $student) : ?>
                          <tr>
                            ...
                            <td>
                              <form action="past-student-assessment.php" method="POST">
