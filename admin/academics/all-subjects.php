...
<head>
  ...
  <title>My Subjects - Academics | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              ...
              <div class="col-auto">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#assignTeacher">Assign</button>
                  ...
                  <div class="card-body">
                    ...
                    <form class="needs-validation add_subject_form" novalidate>
                      <div class="form-group">
                        <input type="text" class="form-control" id="subjectName" name="subject" placeholder="Subject Title" required>
                      ...
                      <button type="submit" class="btn mb-2 btn-success w-100">Add Subject<span class="fe fe-chevron-right fe-16 ml-2"></span></button>
                    </form>
                  </div>
                </div>
              </div>
