          ...
          <div class="col-12">
            ...
            <div class="col-md-12 mb-12 my-3 " id="studentInfoWindow">
              ...
              try {
                ...
                $sql = "SELECT ps.student_id, s.firstName AS student_first_name, s.lastName AS student_last_name, s.id, ps.parent_id, s.admission_no, c.class
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              ...
                              <form id="unlink-form" action="student.php" method="post">
                                <input type="hidden" name="id" value="<?= $dependent['id'] ?>">
                                <input type="hidden" name="parent_id" value="<?= $dependent['parent_id'] ?>">
