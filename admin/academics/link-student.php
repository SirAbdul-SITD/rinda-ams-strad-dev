...
<head>
  ...
  <title>Link Student - Academics | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">Select Student To Link</h2>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
                        ...
                        foreach ($students as $index => $student) : ?>
                          ...
                          <tr>
                            ...
                            <form class='update_form' method='POST'>
                              <td>
                                <select class="form-control select1" required name="relationship">
