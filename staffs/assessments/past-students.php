          ...
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                ...
                <p class="mb-3">The following students are from classes assigned to you, Please select a students to update assessment marks for for <?= $term_name ?> - <?= $session ?> Session</p>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
