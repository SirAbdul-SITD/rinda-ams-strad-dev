          ...
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                ...
                <p class="mb-3">The following subjects are assigned to you, Please select a subject to update assessment marks for <?= $term_name ?> - <?= $session ?> Session</p>
              </div>
            </div>
                        ...
                        <tbody>
                          ...
                          foreach ($subjects as $index => $subject) : ?>
                            <tr data-id="<?= $subject['id']; ?>">
                              ...
                              <td>
                                <form action="past-subject-assessment.php" method="POST">
