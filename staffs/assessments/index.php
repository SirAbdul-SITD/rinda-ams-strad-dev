...
<head>
  ...
  <title>Subjects - Assessments | Rinda AMS</title>
  <!-- Simple bar CSS -->
          ...
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                ...
                <p class="mb-3">The following subjects are assigned to you, Please select a subject to add or update their assessment marks</p>
              </div>
            </div>
