...
<head>
  ...
  <title>Disable Student - Rinda AMS</title>
  <!-- Simple bar CSS -->
...
<body class="vertical  light  ">
  <div class="wrapper">
    ...
    <main role="main" class="main-content">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">Disable Students</h2>
              </div>
            </div>
        ...
        FROM students s
        INNER JOIN classes c ON s.class_id = c.id WHERE s.status != 1";
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
      // Add event listener to all checkboxes with the class 'student-status-toggle'
      document.querySelectorAll('.student-status-toggle').forEach(function(checkbox) {
        checkbox.addEventListener('change', function() {
          const studentId = this.dataset.studentId; // Get the student ID from the data attribute
          const status = this.checked ? 1 : 0; // Get the new status of the student
