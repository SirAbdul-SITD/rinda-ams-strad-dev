...
<head>
  ...
  <title>Parent Profile - Rinda AMS</title>
  <!-- Simple bar CSS -->
  ...
  <div class="wrapper">
      ...
      <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="class_management.pp">
      ...
      <div class="container-fluid">
              ...
              <div class="card profile shadow">
                <div class="card-body my-4">
                  <div class="row align-items-center">
                    ...
                    // Get the admission number from the URL parameter
        ...
        WHERE p.id = :parent_id";
                      ...
                      <div class="col">
                          ...
                          <div class="col">
                            ...
                            <div class="row">
                              ...
                              <p class="student-city">
                                <?= displayIfEmpty($parent['city']); ?>
                              </p>
                            </div>
                            <div class="row">
                              <p class="text-muted">Country: </p>
                              <p class="student-country">
                                <?= displayIfEmpty($parent['country']); ?>
                              </p>
                            </div>
                          </div>
                        </div>
                        <div class="row ">
                          <div class="col-md-4 mb-2">
                            <span class="mb-0">Number of dependant(s): <span id="student-joined">
                                <?= $parent['num_dependents'] ?>
                              </span></span>

                          </div>
                          <div class="mb-2">
                            <button type="button" class="btn mb-2 btn-outline-primary">Edit Profile</button>
                            <button type="button" class="btn mb-2 btn-outline-success">Manage Dependents</button>
              ...
              try {
                ...
                $sql = "SELECT ps.student_id, s.firstName AS student_first_name, s.lastName AS student_last_name,  s.admission_no, c.class
            ...
            WHERE ps.parent_id = :parent_id";
              ...
              foreach ($dependents as $dependent) {
                ...
                echo '<ul class="avatars-list m-0 ml-4">';
                echo '<li>
    <a href="#!" class="avatar avatar-sm">
      <img alt="..." class="avatar-img rounded-circle" src="../assets/avatars/face-3.jpg">
                ...
                echo '</ul>';
                echo '</div>';
                echo '<div class="col pr-0 ml-2">';
                echo '<strong>' . $dependent['student_first_name'] . ' ' . $dependent['student_last_name'] . '</strong>';
                echo '<p class="small text-muted mb-0">' . $dependent['class'] . '</p>'; // Display class name
                echo '</div>';

                echo '<div class="col-auto">';
                echo '<button class="btn btn-sm dropdown-toggle more-vertical" type="button" data-toggle="dropdown"';
                echo 'aria-haspopup="true" aria-expanded="false">';
                echo '<span class="text-muted sr-only">Action</span>';
                echo '</button>';
                echo '<div class="dropdown-menu dropdown-menu-right">';
                echo '<form action="student.php" method="post">';
                echo '<input type="hidden" name="admission_no" value="' . $dependent['admission_no'] . '">';
                echo '<button type="submit" class="dropdown-item">View Student Profile</button>';
                echo '</form>';
                echo '<form action="student.php" method="post">';
                echo '<input type="hidden" name="admission_no" value="' . $dependent['admission_no'] . '">';
                echo '<button type="submit" class="dropdown-item">Unlink Student</button>';
                echo '</form>';
                echo '</div>';
