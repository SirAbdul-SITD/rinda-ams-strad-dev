            ...
            <div class="col-md-12 mb-12 my-3 " id="studentInfoWindow">
              <div class="card profile shadow">
                <div class="card-body my-4">
                  ...
                  $sql = "SELECT s.*, c.class FROM students s INNER JOIN classes c ON s.class_id = c.id WHERE s.admission_no = :admission_no";
                      ...
                      <div class="col">
                        ...
                        <div class="row mb-2">
                          <form class="m-1" action="manage_parents.php" method="post">
                            ...
                            <button type="submit" class="btn mb-2 btn-outline-success">View Parents</button>
                          </form>
                        </div>
