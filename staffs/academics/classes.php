...
<head>
  ...
  <title>My Classes - Academics | Rinda AMS</title>
  <!-- Simple bar CSS -->
              ...
              <div class="col-md-12 ">
                <div class="card shadow">
                  <div class="card-body">
                    ...
                    <?php
                    $sql = "SELECT c.*, s.section, a.teacher_id, a.class_id
                    FROM classes c
                    INNER JOIN sections s ON c.section_id = s.id LEFT JOIN assigned_classes a ON c.id = a.class_id
                    WHERE c.status = 1 AND a.teacher_id = :user
                              ...
                              <td>
                                <form action="students.php" method="POST">
                                  ...
                                  <button type="submit" class="btn  w-100 btn-primary">
                                    Process student assessment</button>
                                </form>
                              </td>
                            </tr>
                          <?php endforeach ?>
