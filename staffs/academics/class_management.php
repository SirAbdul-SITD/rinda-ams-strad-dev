...
<head>
  ...
  <title>Manage Class - Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="page-title">Manage Student Class</h2>
              </div>
            </div>


            <!-- Add New Subject -->
            <div class="col-md-12 mb-12 mr-3">
              <div class="card shadow">
                <div class="card-body">
                  <form class="form-row needs-validation student-info-form">
                    <div class="form-group col-4">
                      <label for="sectionSelect">Select Section</label>
                      <select id="sectionSelect" class="form-control" name="section" required>
                        <?php
                        ...
                        if (count($sections) === 0) {
                          ...
                          foreach ($sections as $section) :
                            ...
                            echo "<option value='$sectionId'>$sectionName Section</option>";
                          endforeach;
                        }
                        ?>
                      </select>
                    ...
                    <div class="form-group  col-4">
                      ...
                      <select id="classSelect" class="form-control" name="class" required disabled>
                        <option value=''>Select Class</option>
                      </select>
                    </div>
                    <div class="form-group col-4">
                      <label for="studentSelect">Select Student</label>
                      <select id="studentSelect" class="form-control select1" required name="student" disabled>
                        <option value=''>Select Student</option>
                      </select>
                    </div>
                    <button type="submit" class="btn mb-2 btn-success w-100 info-form-button">Manage Student Class<span class="fe fe-chevron-right fe-16 ml-2"></span></button>
                  </form>
                </div>
              </div>
            </div> <!-- end section -->
            <div class="col-md-12 mb-12 my-3 " id="studentInfoWindow" style="display: none">
                ...
                <div class="card-body my-4">
                  <div class="row align-items-center">
                    ...
                    <div class="col">
                      <div class="row align-items-center">
                        <div class="col-md-7">
                          <h4 class="mb-1 student-name" id="studentName"></h4>
                          <p class="mb-3"><span class="badge badge-dark student-grade" id="studentReg"></span></p>
                        </div>
                        <div class="col">
                        </div>
                      </div>
                      <div class="row mb-4">
                        <div class="col-md-7">
                          <div class="row">
                            ...
                            <p class="student-class" id="studentClass">Gender</p>
                          </div>
                          <div class="row">
                            <p class="text-muted">Gender: </p>
                            <p class="student-gender" id="studentGender"></p>
                          </div>
                          <div class="row">
                            <p class="text-muted">Date of Birth: </p>
                            <p class="student-dob" id="studentDOB"></p>
                          </div>

                        </div>
                        <div class="col">
                          <p class="">Address: </p>
                          <p class="small mb-0 text-muted" id="studentAddress"></p>
                        </div>
                      </div>
                      <div class="row align-items-center">
                        <div class="col-md-4 mb-2">
                          <span class=" mb-0 ">Joined Date <span id="student-joined"></span></span>
                        </div>
                        <div class="col mb-6">
                          <button type="button" class="btn btn-primary">Promote to next class</button>
                          <button type="button" class="btn btn-secondary">Demote to previous class</button>
                        </div>
                      </div>
                    </div>
                  </div> <!-- / .row- -->
