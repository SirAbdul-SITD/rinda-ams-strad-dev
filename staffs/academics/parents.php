                  ...
                  <div class="card-body">
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        <?php
                        try {
                          // Prepare SQL statement to fetch parent records
                          $sql = "SELECT p.id, p.firstName AS parent_first_name, p.lastName AS parent_last_name, p.email, p.phoneNumber, p.address, p.city, p.state, p.occupation, p.country FROM parents p";
                        ...
                        foreach ($parents as $index => $parent) : ?>
                          <tr>
                            <td>
                              <?= empty($parent['id']) ? 'Nill' : $parent['id'] ?>
                            </td>
                            <td>
                              <?= empty($parent['parent_first_name']) && empty($parent['parent_last_name']) ? 'Nill' : $parent['parent_first_name'] . ' ' . $parent['parent_last_name'] ?>
                            </td>
                            <td>
                              <?= empty($parent['occupation']) ? 'Nill' : $parent['occupation'] ?>
                            </td>
                            <td>
                              <?= empty($parent['email']) ? 'Nill' : $parent['email'] ?>
                            </td>
                            <td>
                              <?= empty($parent['phoneNumber']) ? 'Nill' : $parent['phoneNumber'] ?>
                            </td>
