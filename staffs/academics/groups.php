...
<head>
  ...
  <title>Student Groups - Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="page-title">Student Groups</h2>
              </div>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="card shadow mb-4">
                  <div class="card-body">
                    <?php
                    $query = "SELECT * FROM groups ORDER BY `groups`.`group` ASC";
                          ...
                          foreach ($groups as $index => $group) : ?>
                            <div class="row align-items-center my-3">
                              <div class="col">
                                ...
                                <div class="my-0 text-muted small"><?= $group['range']; ?></div>
                              </div>
                            </div>
                          <?php endforeach; ?>
                        </div> <!-- .col-md-12 -->
                    ...
                    <form action="" method="post">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <select class="custom-select" id="custom-select" required>
