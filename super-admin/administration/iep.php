...
<head>
  ...
  <title>IEP Categories | Rinda AMS</title>
  <!-- Simple bar CSS -->
            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  <div class="col">
                    <h3 class="page-title">IEP Categories</h3>
                  </div>
                  <div class="col-auto">
                    <a href="iep-membership.php">
                      ...
                      <div class="card-body">
                        ...
                        <table class="table datatables" id="dataTable-1">
                          ...
                          <tbody>
                            ...
                            <?php
                            $query = "SELECT * FROM `iep_fees` ORDER BY `iep_fees`.`id` ASC";
                ...
                <div class="modal-body">
                  <form id="editForm">
                    ...
                    <div class="form-group">
                      <label for="edit-iep-category" class="col-form-label">IEP Category:</label>
                      <input type="text" class="form-control" name="edit-iep-category" id="edit-iep-category">
                    </div>

                    <div class="form-group">
                      <label for="edit-iep-amount" class="col-form-label">Amount:</label>
                      <input type="number" class="form-control" name="edit-iep-amount" id="edit-iep-amount">
                    </div>

                    <div class="form-group">
                      <label for="edit-iep-duration" class="col-form-label">Duration:</label>
                      <select class="form-control" name="edit-iep-duration" id="edit-iep-duration" required>
                        <option value='Term'>Term</option>
                        <option value='Whole Session'>Whole Session</option>
                      </select>
                    </div>

                    <input type="hidden" name="edit-iep-id" id="edit-iep-id" value="">
                  </form>
                </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('.table').on('click', '.dropdown-item.edit', function () {
        ...
        var feeId = row.find('.edit-iep-id').val();
        var feeName = row.find('.edit-iep-amount').val();
        var first_term = row.find('.edit-iep-category').val();
        var second_term = row.find('.edit-iep-duration').val();


        // Update form fields with retrieved data
        $('#edit-iep-id').val(feeId);
        $('#edit-iep-amount').val(feeName);
        $('#edit-iep-category').val(first_term);
        $('#edit-iep-duration').val(second_term);
