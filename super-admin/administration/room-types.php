...
<head>
  ...
  <title>Room Types - Hostel | Rinda AMS</title>
  <!-- Simple bar CSS -->
            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  <div class="col">
                    <h3 class="page-title">Room Types</h3>
                  </div>
                  <div class="col-auto">
                    ...
                    <table class="table table-borderless table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>1</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>BQ: 23</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Liberty Hostel</p>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>2</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>AQ: 15</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Heritage Hostel</p>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>3</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>CQ: 10</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Pioneer Hostel</p>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>4</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>DQ: 7</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Sunshine Hostel</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">7</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <tr>
                          <td>5</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>GQ: 18</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Riverside Hostel</p>
                          </td>
                          <td>
