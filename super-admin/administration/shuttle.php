...
<head>
  ...
  <title>Shuttle Categories - Admin | Rinda AMS</title>
  <!-- Simple bar CSS -->
            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  <div class="col">
                    <h3 class="page-title">Shuttle Routes</h3>
                  </div>
                  <div class="col-auto">
                      ...
                      <div class="card-body">
                        ...
                        <table class="table datatables" id="dataTable-1">
                          ...
                          <tbody>
                            ...
                            <?php
                            $query = "SELECT * FROM `routes` ORDER BY `routes`.`id` ASC";
                            ...
                            if (count($fees_type) === 0) {
                              ...
                              foreach ($fees_type as $index => $route): ?>
                                <tr>
                                  ...
                                  <td>
                                    <input type="hidden" value="<?= $route['id']; ?>" class="edit-route-id" ?>
                                    <input type="hidden" value="<?= $route['fare']; ?>" class="edit-route-fare" ?>
                                    <input type="hidden" value="<?= $route['category']; ?>" class="edit-route-category" ?>
                                    <input type="hidden" value="<?= $route['type']; ?>" class="edit-route-type" ?>
                                    <input type="hidden" value="<?= $route['route']; ?>" class="edit-route-route" ?>
                                  ...
                                  <td>
                                    <p>
                                      <?php $formatted_fare = '₦ ' . number_format($route['fare'], 2);
                                      echo $formatted_fare;
                                      ?>
                                    </p>
                                  </td>
                ...
                <div class="modal-body">
                  <form id="editForm">
                    ...
                    <div class="form-group">
                      <label for="edit-route-route" class="col-form-label">Route:</label>
                      <input type="text" class="form-control" name="edit-route-route" disabled id="edit-route-route">
                    </div>

                    <div class="form-group">
                      <label for="edit-route-type" class="col-form-label">Type:</label>
                      <input type="text" class="form-control" name="edit-route-type" disabled id="edit-route-type">
                    </div>
                    ...
                    <div class="form-group">
                      <label for="edit-route-fare" class="col-form-label">Fare:</label>
                      <input type="number" class="form-control" name="edit-route-fare" id="edit-route-fare">
                    </div>



                    <input type="hidden" name="edit-route-id" id="edit-route-id" value="">
                  </form>
                </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label for="fare" class="col-form-label">Amount:</label>
                    <input type="number" class="form-control" name="fare" required>
                  </div>


                  <div class="form-group">
                    <label for="route" class="col-form-label">Duration:</label>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('.table').on('click', '.dropdown-item.edit', function () {
        ...
        var feeId = row.find('.edit-route-id').val();
        var fare = row.find('.edit-route-fare').val();
        var category = row.find('.edit-route-category').val();
        var type = row.find('.edit-route-type').val();
        var route = row.find('.edit-route-route').val();


        // Update form fields with retrieved data
        $('#edit-route-id').val(feeId);
        $('#edit-route-fare').val(fare);
        $('#edit-route-category').val(category);
        $('#edit-route-type').val(type);
        $('#edit-route-route').val(route);
