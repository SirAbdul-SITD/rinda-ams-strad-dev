...
<head>
  ...
  <title>Breakfast Categories | Rinda AMS</title>
  <!-- Simple bar CSS -->
                              ...
                              foreach ($fees_type as $index => $breakfast) : ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <input type="hidden" value="<?= $breakfast['category']; ?>" class="edit-breakfast-category" ?>
                                    <input type="hidden" value="<?= $breakfast['duration']; ?>" class="edit-breakfast-duration" ?>
                ...
                <div class="modal-body">
                  <form id="editForm">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="edit-breakfast-category" id="edit-breakfast-category">
                    </div>
