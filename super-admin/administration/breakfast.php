...
<head>
  ...
  <title>Breakfast Categories - Admin | Rinda AMS</title>
  <!-- Simple bar CSS -->
            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  <div class="col">
                    <h3 class="page-title">Breakfast Categories</h3>
                  </div>
                  <div class="col-auto">
                    <a href="breakfast-membership.php">
                      ...
                      <div class="card-body">
                        ...
                        <table class="table datatables" id="dataTable-1">
                          ...
                          <tbody>
                            ...
                            <?php
                            $query = "SELECT * FROM `breakfast_fees` ORDER BY `breakfast_fees`.`id` ASC";
                            ...
                            if (count($fees_type) === 0) {
                              ...
                              foreach ($fees_type as $index => $breakfast): ?>
                                <tr>

                                  <td>
                                    <input type="hidden" value="<?= $breakfast['id']; ?>" class="edit-breakfast-id" ?>
                                    <input type="hidden" value="<?= $breakfast['amount']; ?>" class="edit-breakfast-amount"
                                      ?>
                                    <input type="hidden" value="<?= $breakfast['category']; ?>"
                                      class="edit-breakfast-category" ?>
                                    <input type="hidden" value="<?= $breakfast['duration']; ?>"
                                      class="edit-breakfast-duration" ?>
                                  ...
                                  <td>
                                    <p class="mb-0 text-muted">
                                      <?php $formatted_amount = '₦ ' . number_format($breakfast['amount'], 2);
                ...
                <div class="modal-body">
                  <form id="editForm">
                    ...
                    <div class="form-group">
                      <label for="edit-breakfast-category" class="col-form-label">breakfast Category:</label>
                      <input type="text" class="form-control" name="edit-breakfast-category"
                        id="edit-breakfast-category">
                    </div>

                    <div class="form-group">
                      <label for="edit-breakfast-amount" class="col-form-label">Amount:</label>
                      <input type="number" class="form-control" name="edit-breakfast-amount" id="edit-breakfast-amount">
                    </div>

                    <div class="form-group">
                      <label for="edit-breakfast-duration" class="col-form-label">Duration:</label>
                      <select class="form-control" name="edit-breakfast-duration" id="edit-breakfast-duration" required>
                    ...
                    <input type="hidden" name="edit-breakfast-id" id="edit-breakfast-id" value="">
                  </form>
                </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('.table').on('click', '.dropdown-item.edit', function () {
        ...
        var feeId = row.find('.edit-breakfast-id').val();
        var feeName = row.find('.edit-breakfast-amount').val();
        var first_term = row.find('.edit-breakfast-category').val();
        var second_term = row.find('.edit-breakfast-duration').val();


        // Update form fields with retrieved data
        $('#edit-breakfast-id').val(feeId);
        $('#edit-breakfast-amount').val(feeName);
        $('#edit-breakfast-category').val(first_term);
        $('#edit-breakfast-duration').val(second_term);
