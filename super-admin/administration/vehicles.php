...
<head>
  ...
  <title>Vehicle - Transportation | Rinda AMS</title>
  <!-- Simple bar CSS -->
                    ...
                    <table class="table table-borderless table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>1</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>RBC-205DE</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">S-23M</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Mus Abbas</p>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>2</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>LKJ-897FG</strong></p>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>3</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>PQR-123GH</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Y-78O</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Fatima Ahmed</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <tr>
                          <td>4</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>XYZ-456KL</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Z-90P</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Aisha Mahmood</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <tr>
                          <td>5</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>MNO-789IJ</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">A-12Q</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Hassan Ali</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button"
                              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
