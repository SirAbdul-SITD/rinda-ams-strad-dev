            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  ...
                  <div class="col-auto">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#eventModal"><span class="fe fe-plus fe-16 mr-3"></span>Add Driver</button>
                  </div>
                </div>
                    ...
                    <table class="table table-borderless table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>1</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>Musa Abbas</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">S-23M</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Lns-22424231313-1331</p>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>2</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>Fatima Ahmed</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">X-45N</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Lns-45454545454-4545</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
                        ...
                        <tr>
                          <td>3</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>Ali Khan</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Y-78O</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Lns-78787878787-7878</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
                        ...
                        <tr>
                          <td>4</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>Aisha Mahmood</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Z-90P</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Lns-90909090909-9090</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
                        ...
                        <tr>
                          <td>5</td>
                          <td>
                            <p class="mb-0 text-muted"><strong>Hassan Ali</strong></p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">A-12Q</p>
                          </td>
                          <td>
                            <p class="mb-0 text-muted">Lns-12121212121-1212</p>
                          </td>
                          <td>
                            <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="text-muted sr-only">Action</span>
