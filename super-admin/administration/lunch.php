            ...
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <div class="row align-items-center my-3">
                  <div class="col">
                    <h3 class="page-title">Lunch Categories</h3>
                  </div>
                  <div class="col-auto">
                    <a href="lunch-membership.php">
                      ...
                      <div class="card-body">
                        ...
                        <table class="table datatables" id="dataTable-1">
                          ...
                          <tbody>
                            ...
                            <?php
                            $query = "SELECT * FROM `lunch_fees` ORDER BY `lunch_fees`.`id` ASC";
                            ...
                            if (count($fees_type) === 0) {
                              ...
                              foreach ($fees_type as $index => $lunch): ?>
                                <tr>

                                  <td>
                                    <input type="hidden" value="<?= $lunch['id']; ?>" class="edit-lunch-id" ?>
                                    <input type="hidden" value="<?= $lunch['amount']; ?>" class="edit-lunch-amount" ?>
                                    <input type="hidden" value="<?= $lunch['category']; ?>" class="edit-lunch-category" ?>
                                    <input type="hidden" value="<?= $lunch['duration']; ?>" class="edit-lunch-duration" ?>
                                  ...
                                  <td>
                                    <p class="mb-0 text-muted">
                                      <?php $formatted_amount = '₦ ' . number_format($lunch['amount'], 2);
                ...
                <div class="modal-body">
                  <form id="editForm">
                    ...
                    <div class="form-group">
                      <label for="edit-lunch-category" class="col-form-label">lunch Category:</label>
                      <input type="text" class="form-control" name="edit-lunch-category" id="edit-lunch-category">
                    </div>

                    <div class="form-group">
                      <label for="edit-lunch-amount" class="col-form-label">Amount:</label>
                      <input type="number" class="form-control" name="edit-lunch-amount" id="edit-lunch-amount">
                    </div>

                    <div class="form-group">
                      <label for="edit-lunch-duration" class="col-form-label">Duration:</label>
                      <select class="form-control" name="edit-lunch-duration" id="edit-lunch-duration" required>
                    ...
                    <input type="hidden" name="edit-lunch-id" id="edit-lunch-id" value="">
                  </form>
                </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('.table').on('click', '.dropdown-item.edit', function () {
        ...
        var feeId = row.find('.edit-lunch-id').val();
        var feeName = row.find('.edit-lunch-amount').val();
        var first_term = row.find('.edit-lunch-category').val();
        var second_term = row.find('.edit-lunch-duration').val();


        // Update form fields with retrieved data
        $('#edit-lunch-id').val(feeId);
        $('#edit-lunch-amount').val(feeName);
        $('#edit-lunch-category').val(first_term);
        $('#edit-lunch-duration').val(second_term);
