          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-md-12 my-4">
                <h2 class="h4 mb-1">Teachers Attendance</h2>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a class="dropdown-item" href="attendance-teachers.html">Attendance</a>
                        ...
                        <tr>
                          <td>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="4575">
                              <label class="custom-control-label" for="4575"></label>
                            </div>
                          </td>
                          <td>2</td>
                          <td>Emily Johnson</td>
                        ...
                        <tr>
                          <td>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="4576">
                              <label class="custom-control-label" for="4576"></label>
                            </div>
                          </td>
                          <td>3</td>
                          <td>Michael Brown</td>
                        ...
                        <tr>
                          <td>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="4577">
                              <label class="custom-control-label" for="4577"></label>
                            </div>
                          </td>
                          <td>4</td>
                          <td>Sarah Lee</td>
                        ...
                        <tr>
                          <td>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="4578">
                              <label class="custom-control-label" for="4578"></label>
                            </div>
                          </td>
                          <td>5</td>
                          <td>John Doe</td>
