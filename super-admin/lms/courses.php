      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editCourseForm">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="editClassLevel">Class Level *</label>
                <select class="form-control" id="editClassLevel" name="class_level" required>
                  <option value="">Select Class Level</option>
                  <option value="Primary 1">Primary 1</option>
                  <option value="Primary 2">Primary 2</option>
                  <option value="Primary 3">Primary 3</option>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.edit-course', function() {
        ...
        if (thumbnail) {
          $('#editThumbnailPreview').html('<img src="../' + thumbnail + '" alt="Current thumbnail" class="img-thumbnail" style="max-width: 200px;">');
        } else {
      ...
      $('#updateCourseBtn').click(function() {
        ...
        $.ajax({
          ...
          error: function(xhr, status, error) {
            ...
            var errorMessage = 'Error updating course';
            try {
              var response = JSON.parse(xhr.responseText);
              if (response.message) {
                errorMessage = response.message;
