...
<head>
  ...
  <title>Admission History - Academics | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">Admission History</h2>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        ...
                        try {
                          ...
                          $sql = "SELECT DISTINCT s.admission_no, CONCAT(s.firstName, ' ', s.lastName) AS full_name, c.class, s.2ndClass_id, s.init_class_id, s.session,
                CASE 
