...
<head>
  ...
  <title>All Students - Academics | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="mb-2 page-title">All Students</h2>
              </div>
            </div>
            <div class="row my-4">
              <!-- Small table -->
                    ...
                    <table class="table datatables" id="dataTable-1">
                      ...
                      <tbody>
                        ...
                        try {
                          ...
                          $sql = "SELECT s.admission_no, s.id, CONCAT(s.firstName, ' ', s.lastName) AS full_name, s.religion, s.address, s.gender, c.class, s.join_date 
            FROM students s
