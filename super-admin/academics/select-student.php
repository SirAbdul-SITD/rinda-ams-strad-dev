...
<head>
  ...
  <title>Select Student | Rinda AMS</title>
  <!-- Simple bar CSS -->
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-3">
              <div class="col">
                <h2 class="page-title">Select Student</h2>
                <p>Kindly select a student to add parent</p>
              </div>
              <div class="col-auto">

                <a href="admit_student.php">
                  <button type="button" class="btn btn-primary"><span class="fe fe-plus fe-16 mr-3"></span>Add
                    Student</button></a>
              </div>
            </div>
            ...
            <div class="col-md-12 mb-12 mr-3">
              <div class="card shadow">
                <div class="card-body">
                  <form class="form-row needs-validation student-info-form" method="POST" action="parents.php">
          ...
          success: function(response) {
            if (response.success) {
              ...
              response.students.forEach(function(student) {
                ...
                name.value = student.firstName + ' ' + student.lastName;
              });
