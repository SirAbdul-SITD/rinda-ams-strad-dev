  ...
  <div class="wrapper">
    ...
    if (isset($_POST['id'])) {
      ...
      try {
        ...
        $sql = "SELECT parent_id FROM parent_student WHERE student_id = :student_id AND status = 1";
        ...
        foreach ($parent_student_rows as $row) {
          ...
          $sql_parent = "SELECT p.id, p.firstName, p.lastName, p.email, p.phoneNumber, p.occupation, ps.relationship_type
                           ...
                           WHERE p.id = :parent_id AND p.status = 1";
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                          <form action="message-parent.php" method="post">
                                            <input type="hidden" name="parent_id" value="<?= $parent['id'] ?>">
                                            <button type="submit" class="dropdown-item">Send Message</button>
                                          </form>
