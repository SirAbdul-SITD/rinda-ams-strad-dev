...
<head>
  ...
  <title>Add Parent | Rinda AMS</title>
  <!-- Simple bar CSS -->
      ...
      <div class="container-fluid">
        <div class="wrapper">
          <div class="align-items-center">
            <form id="registrationForm" class="mx-auto">
              <div class="mx-auto text-center my-4">

                <h2 class="my-3">Add A Parent</h2>
              </div>
              ...
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="city">Current State</label>
              ...
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="occupation">Job description</label>
              ...
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea id="office_address" name="office_address" class="form-control"></textarea>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="occupation">Parenting style adopted at home</label>
                    <textarea id="ps" name="ps" class="form-control"></textarea>
                  </div>
                </div>
              </div>


              <button id="submitBtn" class="btn btn-lg btn-success btn-block" type="submit">Add Parent</button>
              <p class="mt-5 mb-3 text-muted text-center">Powered By Rinda AI © 2024</p>
            </form>
        ...
        fetch('register_parent.php', {
          ...
          .then(response => {
            ...
            if (response.success) {
              ...
              displayPopup(response.message, false); // Show error message
            }
          })
          .catch(error => {
