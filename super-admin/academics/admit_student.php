            ...
            <div class="card my-4">
              ...
              <div class="card-body">
                <form id="example-form" action="admit.php" method="POST">
                  <div id="wizard">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input id="student_dob" name="student_dob" type="date" class="form-control">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="student_religion" name="student_religion" class="form-control">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="student_country" name="student_country" class="form-control">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="student_state" name="student_state" class="form-control">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="student_city" name="student_city" class="form-control">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="session" class="form-control required select1" name="session">
                              <?php
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="term" class="form-control required select1" name="term">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select id="class_id" class="form-control required select1" name="class_id">
                              <?php
                      ...
                      <div class="col-md-4">
                        <div class="form-group mb-3">
                          ...
                          <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="customSwitch4" name="class"
                              onchange="toggleClassInfo('class')">
                            <label class="custom-control-label" for="customSwitch4"><span
                                id="classLabel">No</span></label>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input id="2ndJoin_date" name="2ndJoin_date" type="date" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="2ndSession">Additional Academic Year*</label>
                              <select id="2ndSession" class="form-control select1" name="2ndSession">
                                <?php
                                $query = "SELECT *  FROM sessions";
                                $stmt = $pdo->prepare($query);
                                $stmt->execute();
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select id="2ndTerm" class="form-control select1" name="2ndTerm">
                                <option value="" selected disabled>Select Term</option>
                                <option value="1">First Term</option>
                                <option value="2">Second Term</option>
                                <option value="3">Third Term</option>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select id="2ndClass_id" class="form-control select1" name="2ndClass_id">
                                <?php
                                $query = "SELECT c.*, s.section FROM classes c INNER JOIN sections s ON c.section_id = s.id  WHERE s.status = 1 AND c.status = 1 ORDER BY c.section_id ASC";
                                $stmt = $pdo->prepare($query);
                                $stmt->execute();
                    ...
                    <section>
                      ...
                      <ol>
                        ...
                        <li>
                          <strong>Application Fee:</strong> A non-refundable application fee may be upon
                  ...
                  <input type="hidden" value="<?= $new_admission_no ?>" name="admission_no">
                </form>
              </div> <!-- .card-body -->
            </div> <!-- .card -->
          </div> <!-- .col-12 -->
