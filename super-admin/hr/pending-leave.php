...
<body class="vertical  light  ">
  <div class="wrapper">
    ...
    <main role="main" class="main-content">
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item approve-action" href="#">Approve</a>
      ...
      <!-- ApproveConfirmModal -->
      <div class="modal fade" id="approveConfirmationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <!-- rejectConfirmModal -->
      <div class="modal fade" id="rejectConfirmationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Confirmation</h5>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
              <button type="button" class="btn btn-danger confirm-reject">Reject</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- requestReason -->
      <div class="modal fade" id="requestReasonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              Reason For Leave Request: <span id="request-reason"></span>
            </div>
            <div class="modal-footer">
  ...
  <script>
    ...
    document.body.addEventListener('click', function(event) {
      if (event.target.classList.contains('approve-action')) {
      ...
      } else if (event.target.classList.contains('reject-action')) {
        event.preventDefault();
        const parentTr = event.target.closest('tr');
        const Id = parentTr.dataset.id;
        ...
        // Add click event listener to the confirmation button
        $('#rejectConfirmationModal').one('click', '.confirm-reject', function() {
