...
<head>
  ...
  <title>Compile Message - Messages | Rinda AMS</title>
  <!-- Simple bar CSS -->
                ...
                <div class="col-md-9">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">Message Configurations</strong>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                          ...
                          <div class="col-md-6">
                            <div class="custom-control custom-radio mb-3">
                              ...
                              <p class="text-muted"> Select Parents that will receive this.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <select required class="form-control select2-multi required" id="recipients" name="recipients" aria-placeholder="Search Teachers">
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">Message Content</strong>
                      <span class="float-right"><i class="fe fe-message-circle mr-2"></i>4 recipients</span>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-md-3">
                  <div class="card shadow mb-4">
                    <div class="card-body">
                      ...
                      <p class="text-muted mb-4">Where would you like this message to be sent?</p>
