...
// Base SQL parts for joining students and classes
$baseSQL = "
    FROM students s
    LEFT JOIN classes c ON s.class_id = c.id
    LEFT JOIN classes c2 ON s.2ndClass_id = c2.id
";
...
$dataSQL = "
    SELECT 
        s.id, s.firstName, s.lastName, s.admission_no, 
        c.class AS class, c2.class AS second_class
    $baseSQL
    $where
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center my-4">
              <div class="col">
                <h2 class="h3 mb-0 page-title">Student Contacts</h2>
              </div>
              <!-- Search Bar -->
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-body text-center">
                      ...
                      <div class="card-text my-2">
                        <strong
                          class="card-title my-0"><?= htmlspecialchars($student['firstName'] . ' ' . $student['lastName']) ?></strong>
                        <p class="small text-muted mb-0"><?= htmlspecialchars($student['admission_no']) ?></p>
                        <p class="small"><span
                            class="badge badge-light text-muted"><?= htmlspecialchars($student['class']) ?></span>
                        </p>
                      </div>
                    </div> <!-- ./card-text -->
                    <div class="card-footer">
                      <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                          <small>
                            <?php
                            $maritalStatus = htmlspecialchars($student['second_class']);
                        ...
                        <div class="col-auto">
                          <div class="file-action">
                            ...
                            <div class="dropdown-menu m-2">
                              <form action="../academics/student.php" method="post" target="_blank">
                              ...
                              <form action="compile-notification.php" method="post" target="_blank">
                                <input type="hidden" name="x_id" value="<?= $student['id'] ?>">
