...
<body>
    ...
    <form data-v-3a6f080c="" class="selection" action="compile-notification.php" method="POST">
        ...
        <div data-v-3a6f080c="" class="selection__items selection__items--wrap cards">
            <label class="select-card selection__item" data-v-3a6f080c="" for="select-card__1fw0ahc0v">
                <input name="type" type="radio" class="select-card__input" value="parent" id="select-card__1fw0ahc0v">
            ...
            <label class="select-card selection__item" data-v-3a6f080c="" for="select-card__oy6wafzri">
                <input name="type" type="radio" class="select-card__input" value="teacher" id="select-card__oy6wafzri">
            ...
            <label class="select-card selection__item" data-v-3a6f080c="" for="select-card__x9cwa4e7j">
                <input name="type" type="radio" class="select-card__input" value="staff" id="select-card__x9cwa4e7j">
            ...
            <label class="select-card selection__item" data-v-3a6f080c="" for="select-card__48hcc8mnb">
                <input name="type" type="radio" class="select-card__input" value="student" id="select-card__48hcc8mnb">
        ...
        <br>
        <button id="submit" class="selection__action form-control form-control-lg" type="submit" autofocus="autofocus"
            data-v-3a6f080c="">
